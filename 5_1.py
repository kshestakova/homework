"""
Создайте базовый класс для абстрактной фигуры и классы-наследники для различных геометрических фигур. Пусть в базовом классе будут функции вывода площади и периметра и соответствующие переменные, а также вывод полной информации  о фигуре (имя фигуры, площадь, периметр). 
Для каждого из классов-наследников определите функции задания параметров (можно в конструкторе), изменения параметров, расчета площади, расчета периметра и вывода на экран (через pygame). 
В цикле сгенерируйте 10 любых фигур (лучше разных), выведите их на экран и в консоли для каждой рассчитайте площадь и периметр. 

Задание со “звездочкой” - то же самое, только для объемных фигур (куб, параллелепипед, цилиндр, 4-угольная пирамида, призма). Функции для вычисления объема и площади поверхности. 
""" 
